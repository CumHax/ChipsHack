...
public class BlockInteractionHelper
{
    ...
    public static boolean isInterceptedByOther ( BlockPos originalPos ) {
        return false;
    }

    public static void placeBlock ( BlockPos originalPos, boolean value, boolean b, boolean b1, boolean b2, boolean b3 ) {
