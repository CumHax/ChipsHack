    ...
    public void onRender(RenderGameOverlayEvent.Post event) 
	{
		...
		if (event.getType() == RenderGameOverlayEvent.ElementType.HOTBAR) 
		{
	        ...
	        for (final Module mod : Client.moduleManager.getModules()) {
	            if (mod.isEnabled()) {
	            	if(mod.getCategory() != Category.HUD && mod.getName() != "ClickGUI") {
	        ...
	        for (final String name : list) {
	        	Gui.drawRect((int)(sr.getScaledWidth() - Client.customFontRenderer.getStringWidth(name) - 8), y - 2, (int)(sr.getScaledWidth()), y + 12, new Color(255, 0, 255).getRGB());
	        	Gui.drawRect((int)(sr.getScaledWidth() - Client.customFontRenderer.getStringWidth(name) - 8), y - 2, (int)(sr.getScaledWidth() - Client.customFontRenderer.getStringWidth(name) - 7), y + 12, new Color(255,255, 255).getRGB());
