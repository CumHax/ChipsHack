    ...
    public void onWorldRender(RenderEvent event) {
        for (EntityPlayer p : mc.world.playerEntities) {
            if ((p != mc.getRenderViewEntity()) && (p.isEntityAlive())) {
                double pX = p.lastTickPosX + (p.posX - p.lastTickPosX) * ValueOf.renderPartialTicks
                        - mc.getRenderManager().renderPosX;
                double pY = p.lastTickPosY + (p.posY - p.lastTickPosY) * ValueOf.renderPartialTicks
                        - mc.getRenderManager().renderPosY;
                double pZ = p.lastTickPosZ + (p.posZ - p.lastTickPosZ) * ValueOf.renderPartialTicks
