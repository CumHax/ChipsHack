...
public class BindButton extends SettingButton
{
	...
	{		
		...
		else
		{
			try
			{
				FontUtil.drawStringWithShadow(Keyboard.getKeyName(module.getBind()), (float) ((getX() + getW() - 3) - FontUtil.getStringWidth(Keyboard.getKeyName(module.getBind()))), (float) (getY() + 4), new Color(255, 255, 255, 255).getRGB());
			}
			catch (Exception e)
			{
