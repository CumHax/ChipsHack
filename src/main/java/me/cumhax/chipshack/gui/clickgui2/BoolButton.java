...
public class BoolButton extends SettingButton
{
	...
	public void render(int mX, int mY)
	{
		...
		{
			Client.clickGUI.drawRect(getX() + 88, getY() + 2, getX() + 89, getY() + 15 - 2, new Color(124,11,75, 255).getRGB());
			Client.clickGUI.drawRect(getX() + 99, getY() + 2, getX() + 100, getY() + 15 - 2, new Color(230,5,89, 255).getRGB());
		...
		{
			Client.clickGUI.drawRect(getX() + 88, getY() + 2, getX() + 89, getY() + 15 - 2, new Color(55,48,89, 255).getRGB());
			Client.clickGUI.drawRect(getX() + 99, getY() + 2, getX() + 100, getY() + 15 - 2, new Color(54,47,87, 255).getRGB());
